...
`
const SectionFour = styled.section` background-color: #505393;
color: #ffffff;
text-align: center; .header__section4 {
width: 66%;
   margin: 0 auto;
 }
.title__section4 {
...
padding: 1.35em 0;
color: #ffffff;
border-bottom: 2px solid #464981; text-transform: uppercase; letter-spacing: 0.225em;
margin: 0; }
.grid__section4 {
display: grid; grid-template-columns: 1fr 1fr; width: 66%;
margin: 0 auto;
padding: 3rem 0;
}
.grid__section4 > * {
